...
[`stream_template_string()`](../../api/#flask.stream_template_string) functions automatically
use [`stream_with_context()`](../../api/#flask.stream_with_context) if a request is active.
