...
[example project](https://github.com/pallets/flask/tree/3.1.3/examples/tutorial), which might look a bit
...
out the [Quickstart](../../quickstart/) for an overview of what Flask can do, then
...
[Extensions](../../extensions/) which make tasks like working with the database or
...
1. Source page: https://flask.palletsprojects.com/en/stable/tutorial/next
